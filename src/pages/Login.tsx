    ...
    const handleGoogleLogin = async () => {
      try {
        ...
        if (userContext?.loginWithGoogle) {
          ...
          setMessage("Google login function not available");
          console.error("Google login function not available in context");
        }
      } catch (error: unknown) {
  ...
  return (
    <div className="max-w-md mx-auto mt-20 p-6 bg-white rounded-lg shadow-md">
      ...
      <button
        ...
        className="w-full flex items-center justify-center bg-white border border-gray-300 text-gray-700 py-2 rounded hover:bg-gray-50"
      >
