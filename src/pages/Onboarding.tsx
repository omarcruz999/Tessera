            ...
            <div className="flex items-center space-x-4">
              ...
              <div>
                <button
                  ...
                  className={`px-4 py-2 bg-gray-100 border border-gray-300 rounded hover:bg-gray-200 transition-colors text-white ${isUploading ? 'opacity-50 cursor-not-allowed' : ''}`}
                >
